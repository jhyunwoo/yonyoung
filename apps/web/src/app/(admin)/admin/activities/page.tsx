...
export default function ActivitiesAdminPage({
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const nextImageId =
        selectedImageId && selectedActivity?.detailImages.some((image) => image.id === selectedImageId)
          ? selectedImageId
            ...
            <div className="space-y-3">
              ...
              <label className="block text-sm">
                ...
                <input
                  ...
                  onChange={(event) =>
                    setCreateForm((previous) => ({ ...previous, activityDate: event.target.value }))
                  }
                  className="w-full rounded-md border border-gray-300 px-3 py-2"
                  required
                ...
                <div className="space-y-3">
                  ...
                  <label className="block text-sm">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setEditForm((previous) => ({ ...previous, activityDate: event.target.value }))
                      }
                      className="w-full rounded-md border border-gray-300 px-3 py-2"
                      required
