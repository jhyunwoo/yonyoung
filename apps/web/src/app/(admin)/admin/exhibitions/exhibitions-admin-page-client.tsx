...
export default function ExhibitionsAdminPage({
  ...
  return (
    <div className="space-y-6" data-testid="exhibitions-page">
      ...
      {errorMessage ? (
        <AdminStatusMessage tone="error" testId="exhibitions-error">
          {errorMessage}
        </AdminStatusMessage>
      ) : null}

      {successMessage ? (
        <AdminStatusMessage tone="success" testId="exhibitions-success">
          {successMessage}
        </AdminStatusMessage>
      ) : null}
        ...
        {panelMode === "create" ? (
          ...
          >
            ...
            {scopedGenerationId ? (
              <AdminStatusMessage
                tone="info"
                testId="exhibition-create-scoped-generation-field"
              >
          ...
          <div className="space-y-5">
            ...
            >
              ...
              {scopedGenerationId ? (
                <AdminStatusMessage
                  tone="info"
                  testId="exhibition-edit-scoped-generation-field"
                >
                  소속 기수는 현재 선택한 기수로 고정됩니다.
                </AdminStatusMessage>
              ) : (
