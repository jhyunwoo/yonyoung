...
describe("DashboardMarketPage", () => {
  ...
  it("서버 세션/프로필로 viewer를 구성해 MarketPageClient에 전달한다", async () => {
    const { default: DashboardMarketPage } = await import("./page");
    const tree = await DashboardMarketPage();
