          ...
          {activities.length === 0 ? (
            ...
            activities.map((activity, index) => (
              <MotionReveal key={activity.id} delay={index * 0.03}>
                <article
                  className="overflow-hidden rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-elevated)]"
          ...
          {exhibitions.length === 0 ? (
            ...
            exhibitions.map((exhibition, index) => (
              <MotionReveal key={exhibition.id} delay={index * 0.04}>
                <article
                  className="grid overflow-hidden rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-elevated)] md:grid-cols-[0.46fr_0.54fr]"
                ...
                >
                  ...
                  <div className="space-y-2 p-5">
                    ...
                    <p className="text-sm text-[var(--text-secondary)]">{exhibition.place}</p>
                    <p className="text-sm leading-relaxed text-[var(--text-secondary)]">
