...
export const PAGE_SEO = {
  home: {
    title: "연영회 | 연세대학교 사진 동아리",
    description:
      "연영회는 1966년 창단한 연세대학교 중앙 사진 동아리입니다. 대학생들이 함께하는 정기 출사, 사진 세미나, 사진전과 프로젝트를 만나고 신입 회원 모집 정보를 확인하세요.",
    path: "/",
    keywords: [
      "연영회",
      "연세대학교",
  ...
  about: {
    title: "연영회 소개 | 연세대학교 사진 동아리 활동과 역사",
    description:
      "대학교 사진 동아리에서는 어떤 활동을 할까요? 1966년부터 이어진 연세대학교 중앙사진동아리 연영회의 정기 출사, 사진 세미나, 전시와 역사를 소개합니다.",
    path: "/about",
  ...
  recruiting: {
    title: "연영회 신입 회원 모집 | 연세대학교 사진 동아리",
    description:
